...
contract CredentialDefinitionRegistry is Roles, CredentialSchemaRegistry {
    ...
    function createCredentialDefinition(string memory _name, string memory _version,
        VerificationKey memory _V_Key, bytes32 _credSchema_id, bool _isRevocatable) internal onlyStewardOrTrustAnchor returns(bytes32){
            ...
            CredentialDefinition memory _new_cred_definition = CredentialDefinition(_name,_id,_version,tx.origin,_V_Key,_credSchema_id,_isRevocatable);
